...
public class MainActivity extends AppCompatActivity {
   ...
   // ArrayList<job_adapter_class>job_sugg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barr = (ProgressBar)findViewById(R.id.barr);
        ...
        noti_scroll = (NestedScrollView) findViewById(R.id.noti_scroll);
        jobs_scroll = (NestedScrollView) findViewById(R.id.jobs_scroll);
        mess_scroll = (NestedScrollView) findViewById(R.id.mess_scroll);
        ...
        mess_search = (LinearLayout) findViewById(R.id.message_search);
        ...
        img = (ImageView) headerview.findViewById(R.id.pp);
        background = (ImageView) headerview.findViewById(R.id.background);

        hom = (ImageView)findViewById(R.id.home);
        jobs = (ImageView)findViewById(R.id.job);
        posts = (ImageView)findViewById(R.id.post);
        chats = (ImageView)findViewById(R.id.message);
       ...
       /* TextView jobs,content,profile,products;
        ...
        swipe1 = (SwipeRefreshLayout) findViewById(R.id.swipe1);
        ...
        swipe2 = (SwipeRefreshLayout) findViewById(R.id.swipe2);
        ...
        swipe3 = (SwipeRefreshLayout) findViewById(R.id.swipe3);
        ...
        swipe4 = (SwipeRefreshLayout) findViewById(R.id.swipe4);
    ...
    public void message_search(View v){
